...
class Ball:
    ...
    def __init__(self):
        ...
        self.center.y = random.randint(BALL_RADIUS, SCREEN_HEIGHT - BALL_RADIUS)
    ...
    def draw(self):
     # This will draw the ball on the screen
        arcade.draw_circle_filled(self.center.x, self.center.y, BALL_RADIUS, arcade.color.TURQUOISE)
    ...
    def restart(self):
        ...
        self.center.x = BALL_RADIUS
        self.center.y = random.uniform(0,300)
